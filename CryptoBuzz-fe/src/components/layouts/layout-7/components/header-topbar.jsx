        ...
        <UserDropdownMenu
          trigger={
            userImage && userImage !== toAbsoluteUrl('/media/avatars/300-2.png') ? (
              <div className="cursor-pointer size-[34px] rounded-full inline-flex items-center justify-center relative overflow-hidden border-2 border-green-500">
                <img
                  src={userImage}
                  alt="User Avatar"
              ...
              <div className="cursor-pointer size-[34px] rounded-full inline-flex items-center justify-center relative text-lg font-medium border-2 border-green-500 bg-gradient-to-br from-yellow-400 to-yellow-600 text-white">
                {getUserInitials()}
                {isPremium && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
