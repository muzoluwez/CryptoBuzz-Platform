              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-2 dark:bg-gray-900">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-green-600 font-bold">{idea?.entry || '0'}</span>
                    <CopyIcon 
                      className="w-4 h-4 cursor-pointer hover:text-primary transition-colors"
                      onClick={() => copyToClipboard(idea?.entry, 'Entry price')}
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-3">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-red-600 font-bold">{idea?.invalidation || '0'}</span>
                    <CopyIcon 
                      className="w-4 h-4 cursor-pointer hover:text-primary transition-colors"
                      onClick={() => copyToClipboard(idea?.invalidation, 'Invalidation level')}
                    />
                  </div>
                </div>
