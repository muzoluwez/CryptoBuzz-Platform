        ...
        <div>
          <Card className="max-w-full overflow-hidden rounded-xl shadow-md mb-5">
            ...
            <CardContent className="p-4 pt-2">
              <div className='mb-5'>
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-2 line-clamp-3">Cripto Sync is officially here... and now it's time to master the platform.⚡📱 We invite you to join us LIVE this Wednesday, December 10th at 12PM EST for a special Cripto Sync training hosted by our Director <span className="text-blue-400">...more</span></p>
              </div>
