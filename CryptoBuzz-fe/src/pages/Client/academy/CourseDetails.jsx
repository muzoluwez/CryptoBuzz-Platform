...
function CourseUI({
  ...
  // Determine breadcrumb course title (prefer currentCourse, then API course data)
...
export default function CourseDetails() {
  ...
  // URL parameter handling (support both path param and query param)
  ...
  // Read courseId from route params first, then from query string
  const routeParams = useParams();
  const routeCourseId = routeParams?.courseId || routeParams?.id || null;
  const queryCourseId = params?.get?.("courseId");
  const courseId = routeCourseId || queryCourseId || null;
