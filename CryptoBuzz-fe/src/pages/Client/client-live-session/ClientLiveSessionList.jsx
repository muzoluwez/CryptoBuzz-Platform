                        ...
                        <a href="">
                            <div className="video-library overflow-hidden h-auto relative dark:">
                                ...
                                <div className="video-details absolute bottom-0 p-4">
                                    <div className="flex items-center justify-between pt-2">
                                        <a href="#" className=" bg-black text-white p-1 justify-center rounded-sm text-xs">{stream.viewers || 0} Viewers</a>
                                    </div>
                                </div>
                                <div className="live absolute top-5 left-5">
                                    <a href="#" className=" bg-red-700 text-white pl-1 pr-1 font-semibold bg-red justify-center rounded-sm text-sm">Live</a>
                                </div>
                            </div>
                            <div className="session-details flex items-start gap-3 w-100 mt-3">
                                ...
                                <div className="session-content">
                                    <h5 className="text-black text-md font-semibold" onClick={() => navigate(`/live-session/${stream.id}`)}>{stream?.state?.custom?.title}</h5>
                                    <h6 className="text-black text-sm text-gray-700 hover:text-gray-900">mbAdmin</h6>
                                    <div className="flex gap-2 my-3">
                                        <span className="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-gray-500/10 ring-inset">Capa</span>
                                        <span className="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-gray-500/10 ring-inset">Espanol</span>
                                        <span className ="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-gray-500/10 ring-inset">Drop</span>
                                        <span className ="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-gray-500/10 ring-inset">Drop</span>
                                    </div>
                                </div>
                            </div>
