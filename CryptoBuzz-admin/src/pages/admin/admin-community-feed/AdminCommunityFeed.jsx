...
/**
 * AdminCommunityFeed Component
 * 
 * Full-featured community feed for admin with:
 * - Profile card with cover and avatar
 * - Create post functionality with media upload
          ...
          <div className="md:col-span-12 lg:col-span-3 xl:col-span-4 space-y-4 mb-5">
            ...
            {postsStatus === 'loading' ? (
              ...
              <div className="card rounded-lg shadow-md p-8 text-center">
                ...
                <p className="text-gray-500 mb-4 font-termina">Be the first to share something with the community!</p>
              ...
              >
                {posts.map((post) => (
                  <PostCard
                    ...
                    isOwnPost={post.author?.id === auth?.user?._id}
