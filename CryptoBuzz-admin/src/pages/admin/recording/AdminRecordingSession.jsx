...
import RecordingThumbnail from "../../../components/common/RecordingThumbnail";
import {
  KeenIcon,
  MenuIcon,
  MenuLink,
...
const AdminRecordingSession = () => {
  const [trigger, { data, isFetching, isError, error, refetch }] =
  ...
  // callback to refetch after delete or update
  const handleRefresh = () => {
    if (id) trigger(id);
    setIsCreateOpen(false);
    setIsDeleteOpen(false);
...
export default AdminRecordingSession;
