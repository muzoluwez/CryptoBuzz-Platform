...
import EducatorTradeSlider from './EducatorTradeSlider';

const ViewEducatorTradeIdeas = forwardRef(({ isViewOpen, handleCloseView, selectedIdea, setIsLightBoxOpen }, ref) => {
    return (
                ...
                <div className="grid gap-5 px-0">
                    <div className="grid grid-cols-12 gap-4">
                        <div className="col-span-12">
                            ...
                            <div className=''>
                                <EducatorTradeSlider sliderImages={selectedIdea?.image} setIsLightBoxOpen={setIsLightBoxOpen} selectedIdea={selectedIdea} />
                            </div>
...
export default ViewEducatorTradeIdeas
