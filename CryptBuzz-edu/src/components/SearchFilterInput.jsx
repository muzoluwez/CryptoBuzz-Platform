    ...
    <div className="relative w-full">
      <input
        ...
        className={`flex w-full  items-center justify-between h-9.5 rounded-md border ring-0 ring-offset-0 px-8 py-2 pr-8 text-[0.8125rem] font-medium outline-none transition-colors duration-200
          ${
            isDark
              ? "bg-[#f3f4f6] border-gray-700 text-gray-100 placeholder-gray-400  dark:placeholder-gray-800 hover:border-gray-500 focus:border-yellow-500 focus:ring-0 caret-gray-200"
        ...
        style={{
          ...
          backgroundColor: isDark ? "#1f212a" : undefined,
        }}
      />
